                ...
                <form class="form-inline">
                    <div class="form-group">
                        <label for="exampleInputName2">키워드</label>
                            <input type="text" name="keyword"class="form-control" id="keyword" value="<?php echo isset($_GET['keyword']) ? $_GET['keyword'] : '' ?>" placeholder="안국 어니언"/>
                    </div>
                    <div class="form-group">
        ...
        <p class="lead">
            <?php
                if(isset($_GET["search"])){
                    ...
                    $env = array('PATH' => '/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games','LANG' => 'ko_KR.UTF-8');
